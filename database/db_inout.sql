...
-- Tiempo de generación: 04-12-2023 a las 16:33:27
...
ALTER TABLE `detalle_ubicacion`
  ...
  ADD KEY `elemento_ubicacion` (`fk_elemento`),
...
ALTER TABLE `detalle_ubicacion`
  ...
  ADD CONSTRAINT `elemento_ubicacion` FOREIGN KEY (`fk_elemento`) REFERENCES `elementos` (`codigo_elemento`);
